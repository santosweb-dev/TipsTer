                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Esporte</label>
                                    <select class="form-control select2 select2-hidden-accessible" name="" data-select2-id="1" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="" data-select2-id="2" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                   ...
                                   <!-- <select class="form-control select2 select2-hidden-accessible" name="" data-select2-id="4" tabindex="-1" aria-hidden="true">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" name="" data-select2-id="3" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="0,00" data-allow-zero="false" data-affixes-stay="true" data-thousands="." data-decimal="," tabindex="6" name="stake" class="form-control money" id="stake" placeholder="Valor apostado" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">R$ </span>
                                        <input type="text" data-affixes-stay="true" data-thousands="." tabindex="7" data-decimal="," name="result" data-allow-negative="true" data-allow-zero="true" class="form-control money" id="result" placeholder="Lucro ou Prejuízo Obtido" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
