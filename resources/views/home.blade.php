                            ...
                            <div class="table-responsive">
                                <table class="table table-vertical">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-2.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Herbert C. Patton
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-3.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Mathias N. Klausen
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-4.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Nikolaj S. Henriksen
                                            </td>
                                            <td>
                                                <i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-5.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Lasse C. Overgaard
                                            </td>
                                            <td>
                                                <i class="mdi mdi-checkbox-blank-circle text-danger"></i> Payment expired
                                            </td>
                                            <td>
                                                $44,584
                                                <p class="m-0 text-muted font-14">Amount</p>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-6.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Kasper S. Jessen
                                            </td>
                                            <td>
                                                <i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm
                                            </td>
                                ...
                                <table class="table table-vertical mb-1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-1.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> Riverston Glass Chair
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-2.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> Shine Company Catalina
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-success">Delivered</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-3.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> Trex Outdoor Furniture Cape
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-4.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> Oasis Bathroom Teak Corner
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-5.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> BeoPlay Speaker
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-success">Delivered</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-6.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"> Riverston Glass Chair
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-success">Delivered</span>
                                            </td>
