<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light bg-default navbar-shadow">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('home')}}">
                        ...
                        <h3 class="brand-text">tipster</h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">{{ __('Olá') }},
                                <span class="user-name text-bold-700">{{ Auth::user()->name }}</span>
                            </span>
                            <span class="avatar avatar-online">
                                @if (Auth::user()->avatar  == '')
                                    <img src="{{asset('storage/users/user-default.png')}}" alt="avatar"><i></i>
                                @else
                                    <img src="{{asset('storage/users/'.Auth::user()->avatar )}}" alt="avatar"><i></i>
                                @endif
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="#"><i class="ft-power"></i> {{ __('Sair') }}</a>
                        </div>
                    </li>
